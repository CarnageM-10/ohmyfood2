...
//inclure la page de connexion
 ...
 if(isset($_GET['id'])){// si un id est envoyé alors:
    ...
    $produit =  mysqli_query($con, "SELECT * FROM product WHERE id = $id");
    ...
    if(isset($_SESSION['panier3'][$id])){//si le produit est dans le panier
        $_SESSION['panier3'][$id]++; //représente la quantité
    }else {
        //si non on ajoute le panier
        $_SESSION['panier3'][$id]=1;   
    }
//redirection vers la page detail.php
    
 }
 header("Location:tandem.php");
?>