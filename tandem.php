...
<body>
    <div class="high">
        ...
        <a href="paniertan.php" class="link">panier<span><?=array_sum($_SESSION['panier3'])?></span></a>
    </div>   
    <div class="haut"> <img src="tandem/Pngtreesummer atmosphere restaurant supermarket vegetable_1098004.jpg" alt=""></div>
    <main>
        <div class="list">
            <div class="palette"><em>Le Tandem</em>  <i class="fa-regular fa-heart"></i> </div>
            <h3 class="titre">ENTREE</h3>
            <div class="sec">
            <?php 
        //inclure la page de connexion
        include_once "con_dbb3.php";
        //afficher la liste des produits
         $req = mysqli_query($con, "SELECT * FROM product");
         while( $row =mysqli_fetch_assoc($req)){
        ?>
            <button> 
                <img src="tandem/<?=$row['img'] ?>" alt="">
                <h3>
                    <p class="menu"> <?=$row['name'] ?></p>
                </h3>
                <p class="Acc"></p>
                <p class="Prix"><b><?=$row['price'] ?></b></p>
                <a href="ajouter_paniertan.php?id=<?=$row['id']?>" class="id_product">Ajouter au panier</a>
                </p>
        ...
        ?>
            <button> 
                ...
                <p class="Acc"></p>
                <p class="Prix"><b><?=$row['price'] ?></b></p>
                <a href="ajouter_paniertan2.php?id=<?=$row['id']?>" class="id_product">Ajouter au panier</a>
                </p>
        ...
        ?>
            <button> 
                ...
                <p class="Acc"></p>
                <p class="Prix"><b><?=$row['price'] ?></b></p>
                <a href="ajouter_paniertan3.php?id=<?=$row['id']?>" class="id_product">Ajouter au panier</a>
                </p>
